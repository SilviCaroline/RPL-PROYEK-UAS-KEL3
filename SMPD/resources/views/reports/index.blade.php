...
<div class="flex min-h-screen">
    <aside class="w-72 bg-blue-950 text-white p-6 hidden md:block">
        ...
        <nav class="space-y-3">
            ...
            <a href="{{ route('statistics.index') }}" class="block px-4 py-3 hover:bg-blue-900 rounded-lg">Statistik</a>
    ...
    <main class="flex-1 p-6 md:p-10">
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex gap-3">
                <a href="{{ route('reports.export.pdf') }}" class="bg-red-600 text-white px-5 py-3 rounded-lg hover:bg-red-700">
                    Export PDF
                </a>

                <a href="{{ route('reports.export.excel') }}" class="bg-green-600 text-white px-5 py-3 rounded-lg hover:bg-green-700">
                    Export Excel
                </a>
            </div>
        </div>
