...
<section class="bg-blue-950 text-white py-14">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <p class="text-blue-100">Cari koleksi buku berdasarkan judul, penulis, atau kategori.</p>
    </div>
</section>
...
<main class="max-w-7xl mx-auto px-6 py-10">
    <form action="{{ route('opac.index') }}" method="GET" class="bg-white p-6 rounded-2xl shadow mb-8">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <a href="{{ route('opac.index') }}" class="border border-slate-300 px-6 py-3 rounded-lg text-center hover:bg-slate-50">
                Reset
            </a>
        </div>
    </form>
            ...
            <div class="bg-white rounded-2xl shadow overflow-hidden">
                ...
                <div class="p-5">
                    ...
                    <div class="mt-3 flex justify-between items-center">
                        <span class="text-sm">Stok: {{ $book->stock }}</span>

                        @if($book->stock > 0)
                            <span class="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full">Tersedia</span>
                        @else
                            <span class="text-xs bg-red-100 text-red-700 px-3 py-1 rounded-full">Habis</span>
                        @endif
                    </div>
