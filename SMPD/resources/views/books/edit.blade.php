    ...
    <div class="bg-white rounded-2xl shadow p-8 mt-6">
        ...
        <form action="{{ route('books.update', $book->id) }}" method="POST" class="grid md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ $book->title }}" class="w-full border rounded-lg px-4 py-3" required>
            </div>

            <div>
                <label class="block mb-2 font-medium">Penulis</label>
                <input type="text" name="author" value="{{ $book->author }}" class="w-full border rounded-lg px-4 py-3" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="publisher" value="{{ $book->publisher }}" class="w-full border rounded-lg px-4 py-3">
            </div>
            ...
            <div>
                ...
                <input type="text" name="isbn" value="{{ $book->isbn }}" class="w-full border rounded-lg px-4 py-3">
            </div>

            <div>
                <label class="block mb-2 font-medium">Stok</label>
                <input type="number" name="stock" value="{{ $book->stock }}" class="w-full border rounded-lg px-4 py-3" required>
            </div>

            <div>
                <label class="block mb-2 font-medium">Barcode</label>
                <input type="text" name="barcode" value="{{ $book->barcode }}" class="w-full border rounded-lg px-4 py-3" required>
            </div>
