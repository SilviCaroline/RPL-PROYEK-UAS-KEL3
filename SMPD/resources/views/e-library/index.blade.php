...
<div class="flex min-h-screen">
    <aside class="w-72 bg-blue-950 text-white p-6 hidden md:block">
        ...
        <nav class="space-y-3">
            <a href="{{ route('dashboard', ['role' => request('role', 'pengguna')]) }}" class="block px-4 py-3 hover:bg-blue-900 rounded-lg">Dashboard</a>
            <a href="{{ route('opac.index') }}" class="block px-4 py-3 hover:bg-blue-900 rounded-lg">Katalog Buku</a>
            <a href="{{ route('reservations.index') }}" class="block px-4 py-3 hover:bg-blue-900 rounded-lg">Reservasi Buku</a>
            <a href="{{ route('elibrary.index') }}" class="block px-4 py-3 bg-blue-900 rounded-lg">E-Library</a>
